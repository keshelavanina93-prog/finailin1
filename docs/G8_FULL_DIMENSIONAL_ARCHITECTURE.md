...
The latest implementation head is `2d89834` on the converged implementation
...
promotion and live operational telemetry remain open; accepted measurement-series quality is now projected through the read-only petroleum telemetry bridge.
