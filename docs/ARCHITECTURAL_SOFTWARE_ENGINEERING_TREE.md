...
The canonical checkout is clean at `831a7a7`; the same implementation head is
...
with Z-report identity, fiscal-close state and Store/CashRegister semantic-binding validation.
