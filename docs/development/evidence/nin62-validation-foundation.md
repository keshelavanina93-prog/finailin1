...
The repaired gate passed for `e4a7e47eea5834773704f353c178a09014c2cfa1` in run `34179637590`: 1,370 passed, 18 skipped, two warnings, 682.13 seconds. Exactly 14,576 of 16,177 statements were covered (1,601 missed), displayed as 90.10%. The integer comparison passed, as did the web/contracts job, both capped Linux probes, 22 gate checks and 12 preparation checks. The full log is retained locally as `.finai/artifacts/nin62-exact-gate-ci.log`. This accepts that candidate's CI boundary; subsequent PROV/index source changes need their own full gate and canonical runtime/browser acceptance remains open.
