...
latest implementation head is `eb95776`; frontend lint and typecheck pass for the changed surfaces, with learning shadow evaluation, petroleum conservation/lineage, and source-family operational validation represented in the unified workspaces.
...
between governed-promotion eligibility and disabled canonical promotion. Retail cash-register shift-close intake is represented as a wired, partially implemented source family with explicit missing Z-report and semantic-binding evidence. Retained source
