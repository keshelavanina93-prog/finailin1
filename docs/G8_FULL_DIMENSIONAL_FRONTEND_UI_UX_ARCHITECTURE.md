...
latest implementation head is `09dbe23`; frontend lint and typecheck pass for the changed surfaces, with learning shadow evaluation, petroleum conservation/lineage, source-family operational validation, explicit measurement-grain declarations, semantic-binding readback, and shared operational intake contracts represented in the unified workspaces.
