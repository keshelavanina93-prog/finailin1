...
TYPE_FIELDS: dict[str, dict[str, str]] = {
    ...
    "ExternalOntologyModule": {
        "release_id": "@ExternalOntologyRelease",
        "evidence_id": "@SourceEvidence",
        "definition": "OntologyDefinition",
    },
    "OntologyImportRun": {
    ...
    "RuntimeAgent": {
        "deployment_target_id": "@DeploymentTarget",
        "definition": "OntologyDefinition",
    },
    "DesiredState": {
        "deployment_target_id": "@DeploymentTarget",
    ...
    "CertificationContract": {
        "subject_schema_id?": "@SchemaDefinition",
        "definition": "OntologyDefinition",
    },
    ...
    "LicenceNoticeBinding": {
        "notice_id": "@SourceLicenceNotice",
        "company_id": "@LegalEntity",
        "licence_id": "@Licence",
    ...
    "CorporateDisclosureBinding": {
        "observation_id": "@SourceCorporateObservation",
        "reporter_id": "@LegalEntity",
        "related_entity_id": "@LegalEntity",
        "reporter_code": "Identifier",
        "reporting_year": "Count",
        "source_url": "Text",
    ...
    "FactReconciliation": {
        "left_contract_id": "@FactContract",
        "right_contract_id": "@FactContract",
        "definition": "OntologyDefinition",
    },
    "SourceJournalMovement": {
        "legal_entity_id": "@LegalEntity",
        "debit_account_id": "@LocalAccount",
        "credit_account_id": "@LocalAccount",
        "source_record_id": "@SourceRecord",
        "posting_date": "Date",
        "document_reference": "Text",
        "amount": "Amount",
        "source_family": "Identifier",
        "source_row_key": "Identifier",
        "unit_status": "Identifier",
        "source_details": "OntologyDefinition",
    },
    "SourceTrialBalanceRow": {
        ...
        "period_start": "Date",
        "period_end": "Date",
        "source_row_role": "Identifier",
        "source_row_key": "Identifier",
        "parent_source_row_key?": "Identifier",
        "source_family": "Identifier",
        "unit_status": "Identifier",
        "source_details": "OntologyDefinition",
        "opening_debit?": "Amount",
        "opening_credit?": "Amount",
        "turnover_debit?": "Amount",
        "turnover_credit?": "Amount",
    ...
    "ObjectTypeImplementation": {
        "interface_id": "@ObjectInterface",
        "schema_id": "@SchemaDefinition",
        "definition": "OntologyDefinition",
    },
    ...
    "CompanyWorkspace": {
        "company_id": "@LegalEntity",
        "enterprise_id": "@EnterpriseGroup",
        "domain_pack_id": "@DomainPack",
        "rationale": "Text",
    },
    ...
    "SourceDimensionAssignment": {
        "observation_id": "@SourceJournalMovement",
        "company_dimension_id": "@CompanyDimension",
        "member_id": "@DimensionMember",
        "source_record_id": "@SourceRecord",
    },
    ...
    "Dispenser": {"code": "Identifier", "station_id": "@Station"},
    "Nozzle": {"code": "Identifier", "dispenser_id": "@Dispenser", "product_id?": "@Product"},
    "Asset": {
        "code": "Identifier",
        "facility_id?": "@Facility",
        "legal_entity_id?": "@LegalEntity",
    },
    "Meter": {"code": "Identifier", "asset_id": "@Asset", "location_id": "@Location"},
    "Tank": {"code": "Identifier", "facility_id": "@Facility", "product_id?": "@Product"},
    "Store": {
        "code": "Identifier",
        "legal_entity_id?": "@LegalEntity",
        "location_id?": "@Location",
    },
    "CashRegister": {"code": "Identifier", "store_id": "@Store"},
    "PhysicalMovement": {
        "legal_entity_id": "@LegalEntity",
        "movement_id": "Identifier",
        "movement_type": "Identifier",
    ...
    "PhysicalMeasurement": {
        ...
        "value": "Amount",
        "unit": "Unit",
        "pressure_basis": "Identifier",
        "temperature_basis": "Identifier",
    ...
    "CashRegisterShiftClose": {
        ...
        "event_time": "Time",
        "z_report_id": "Identifier",
        "fiscal_close_status": "Identifier",
        "currency": "CurrencyCode",
        "gross_amount": "Amount",
        "net_amount": "Amount",
        "payment_method": "Identifier",
    ...
    "SourceJournalCompatibility": {
        ...
        "scope_id": "@SourceAccountingScope",
        "legal_entity_id": "@LegalEntity",
        "ledger_id": "@Ledger",
        "book_id": "@AccountingBook",
        "period_id": "@FiscalPeriod",
    ...
    "FunctionDefinition": {
        "object_set_id?": "@ObjectSetDefinition",
        "definition": "OntologyDefinition",
        "accounting_binding_id?": "@SourceAccountingBinding",
        "source_scope_id?": "@SourceAccountingScope",
        "minimum_authority_state?": "Identifier",
    },
    "TransformationDefinition": {
        "minimum_authority_state?": "Identifier",
        "definition": "OntologyDefinition",
        "resource_budget?": "OntologyDefinition",
    ...
    "SourceAccountingScope": {
        ...
        "date_basis": "Identifier",
        "coverage_state": "Identifier",
        "evidence_id": "@SourceEvidence",
    },
    "SourceFamily": {
        "company_id": "@LegalEntity",
        "baseline_binding_id": "@SourceAccountingBinding",
        "family_key": "Identifier",
        "source_system": "Identifier",
        "definition": "OntologyDefinition",
    },
    "SourceSnapshotAdoption": {
        "company_id": "@LegalEntity",
        "family_id": "@SourceFamily",
        "predecessor_binding_id": "@SourceAccountingBinding",
        "successor_binding_id": "@SourceAccountingBinding",
        "predecessor_adoption_id?": "@SourceSnapshotAdoption",
        "definition": "OntologyDefinition",
    },
    "SourceAccountingBinding": {
        "scope_id": "@SourceAccountingScope",
        "source_use": "Identifier",
        "ledger_id?": "@Ledger",
        "book_id?": "@AccountingBook",
        "period_id?": "@FiscalPeriod",
        "currency_id?": "@Currency",
        "currency_role?": "Identifier",
        "rationale": "Text",
        "contract_version?": "Identifier",
        "functional_currency_id?": "@Currency",
        "transaction_currency_id?": "@Currency",
        "reporting_currency_id?": "@Currency",
        "currency_policy?": "Identifier",
        "account_mapping_id?": "@MappingVersion",
        "dimension_mapping_id?": "@MappingVersion",
        "granularity?": "Identifier",
        "deepest_valid_drill?": "Identifier",
        "amount_field?": "Text",
        "amount_semantics?": "Identifier",
        "unresolved_reason?": "Text",
        "vat_treatment?": "Identifier",
        "supplementary_amount_field?": "Text",
