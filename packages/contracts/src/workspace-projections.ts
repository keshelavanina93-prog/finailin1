...
export type ProjectionDefinition = { projection_id: string; kind: ProjectionKind; label: string; workspaces: string[]; selection_fields: string[]; backend_contracts: string[]; status: ProjectionStatus; authority_effect: "NONE" };
