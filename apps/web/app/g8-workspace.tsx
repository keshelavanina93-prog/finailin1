...
function SignedIn({token,principal,onSignOut}: {token:string;principal:Principal;onSignOut:()=>void}) {
  ...
  const navigate = (next:View) => {setCompanyInitialTab(undefined);setView(next);setTrace(null);setMenu(false);setSearch("");};
