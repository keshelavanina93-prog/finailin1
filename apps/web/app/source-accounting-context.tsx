...
export default function SourceAccountingContext({ token, documentId, sheet, profile, companyId, canPropose, onProposal, onInspectResource, onTraceResource, compactCompanyIdentity = false }: {
  ...
  return <section><h3>Source accounting context</h3>
    ...
    {context && <>
      ...
      {profile === "seg_expense_base" && context.accounting_eligibility?.eligible_for_accounting !== true && <p>The source amount and annotated Amount require an eligible reviewed accounting interpretation. Petroleum counterparty labels do not identify the source company.</p>}
