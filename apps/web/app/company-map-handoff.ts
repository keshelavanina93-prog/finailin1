...
export type CompanyForegroundEntry=Omit<CompanyOriginEntry,"reference">&{reference:CompanyWorkReference|CompanyMapHandoff;mapState?:MapWorkspaceState;mapSelection?:MapSelection|null};
...
export function restoreCompanyMapFocus(origin:JournalReviewDomOrigin&{focus:HTMLElement|null},main:HTMLElement|null):boolean {
