...
import type {AnalysisField,AnalysisValue,CompanyHomeDescriptor,CanonicalResource} from "@finai/contracts";
...
type Props={token:string;companyId:string;snapshot?:{validAt:string;knownAt:string};onData:()=>void;onOperations:(state:MapWorkspaceState)=>void;onMapSelection:(selection:MapSelection|null)=>void;onInspect?:(node:CanonicalResource,knownAt:string)=>void;onAccounting?:()=>void};
...
function Home({token,companyId,snapshot,onData,onOperations,onMapSelection,onInspect,onAccounting}:Props){
