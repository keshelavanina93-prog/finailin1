...
function Connections({token,selection,companyId,onSelect}:Props){
 ...
 return <section className="ops-connections" data-operations-connections tabIndex={-1}><h3>Recorded downstream connections · {resource.display_name}</h3><p>Two steps along explicit directed relationships. Connectivity is not a hydraulic or customer-impact prediction.</p>
