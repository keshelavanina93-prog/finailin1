    ...
    <div className="review-layout">
      <div>
        ...
        <div className="stage-content">
          {stage === "preserve" && <><h3>Retained source evidence</h3><p>Original submitted UTF-8 content is retained with this construction.</p><code className="full-hash">{receipt.source_sha256}</code><p>Submitted by {detail.submitted_by ?? "Legacy identity unavailable"} · {new Date(detail.ingested_at).toLocaleString()}</p></>}
