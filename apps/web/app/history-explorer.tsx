...
export default function HistoryExplorer({token,companyId,companyName,contextKey,onInspect,onHistory,onTrace}:{
  ...
  onInspect:(resource:CanonicalResource,knownAt:string)=>void;onHistory:(resource:CanonicalResource,knownAt:string)=>void;onTrace:(resource:CanonicalResource,knownAt:string)=>void;
}) {
