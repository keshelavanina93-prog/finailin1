...
async function forward(request: NextRequest, context: Context) {
  ...
  const planning = request.method === "GET" && /^planning\/(?:catalog|compare|forecast)$/.test(route);
