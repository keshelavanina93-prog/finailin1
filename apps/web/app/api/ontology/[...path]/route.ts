...
async function forward(request: NextRequest, context: Context) {
  ...
  const investigationActions=request.method==="POST"&&route==="operations/investigations";
