...
async function forward(request: NextRequest, context: Context) {
  ...
  const analysisProjection=request.method==="POST"&&(route==="analysis/project"||route==="company-home"||route==="company-changes"||route==="company-journals/reconciliation/projection");
