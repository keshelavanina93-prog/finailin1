...
async function forward(request: NextRequest, context: Context) {
  ...
  const retention = /^retention\/(?:inspect|history|evaluations|receipts\/[a-fA-F0-9-]+)$/.test(route);
